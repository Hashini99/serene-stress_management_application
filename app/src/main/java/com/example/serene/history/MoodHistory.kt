...
//change colour
                if(model.mood == "happy"){
                    tv_mood.setTextColor(Color.parseColor("#dbba00"))
                }
                else if(model.mood == "sad"){
                    tv_mood.setTextColor(Color.parseColor("#ffaa00"))
                }
                else if(model.mood == "moderate"){
                   tv_mood.setTextColor(Color.parseColor("#0091ff"))
               }
                else if(model.mood == "angry"){
                    tv_mood.setTextColor(Color.parseColor("#00ff00"))
                }
                else {
                    tv_mood.setTextColor(Color.parseColor("#ff0000"))
                }
