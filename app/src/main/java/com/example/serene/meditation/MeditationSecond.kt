...
import kotlinx.android.synthetic.main.activity_meditation_second.*
//import kotlinx.android.synthetic.main.activity_meditation_second_phase.*
import kotlinx.android.synthetic.main.meditation_congrats_dialog.view.*
import kotlinx.android.synthetic.main.meditation_level_dialog.view.*
import kotlinx.android.synthetic.main.pomodoro_dialog.view.*
import kotlinx.android.synthetic.main.meditation_setting_dialog.view.*

class MeditationSecond : AppCompatActivity() { //Timer variables
...
//        savedProgressMax = sharedPreferences.getInt("PROGRESS_MAX", 1)
    ...
    fun currentLevelButton(view: View) {
        ...
        val mDialogView = LayoutInflater.from(this).inflate(R.layout.meditation_level_dialog, null)
    ...
    private fun createSettingButton() {
        ...
        val mDialogView = LayoutInflater.from(this).inflate(R.layout.meditation_setting_dialog, null)
        val mBuilder = AlertDialog.Builder(this)
            .setView(mDialogView)
...
//}
//
//fun getSharedPreferences(s: String, modePrivate: Int): Any {
//
//}
//
////Dialog on Level Up
